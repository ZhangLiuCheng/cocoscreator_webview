...
cc.sys.platform === cc.sys.ANDROID ? null != jsb && "undefined" != jsb && jsb.reflection.callStaticMethod("AppController", "openShop:", e) : cc.sys.os === cc.sys.OS_IOS ? null != jsb && "undefined" != jsb && jsb.reflection.callStaticMethod("org/cocos2dx/javascript/AppActivity", "openShop", "(Ljava/lang/String;)V", e) : cc.log("跳转商城");
}
});
cc._RF.pop();
}, {} ],
